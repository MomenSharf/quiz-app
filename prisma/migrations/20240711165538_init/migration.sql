...
CREATE TABLE "Like" (
    ...
    CONSTRAINT "Like_pkey" PRIMARY KEY ("userId","quizId")
);
...
CREATE TABLE "Bookmarked" (
    ...
    CONSTRAINT "Bookmarked_pkey" PRIMARY KEY ("userId","quizId")
);
...
-- AddForeignKey
ALTER TABLE "Bookmarked" ADD CONSTRAINT "Bookmarked_quizId_fkey" FOREIGN KEY ("quizId") REFERENCES "Quiz"("id") ON DELETE CASCADE ON UPDATE CASCADE;
