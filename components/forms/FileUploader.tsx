...
export function FileUploader({
  ...
  return (
    <div
      {...getRootProps()}
      className="flex justify-center  cursor-pointer flex-col overflow-hidden rounded-lg bg-grey-50"
    >
      <input
        {...getInputProps()}
      ...
      {image ? (
        <div className="relative">
          <div className="flex w-full h-72 flex-1 justify-center items-center">
            <img
              src={image}
              alt="image"
