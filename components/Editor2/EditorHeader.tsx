...
export default function EditorHeader() {
  const {
    ...
    state: { saveState, historyArray, isEditingTitle, isSettingsOpen },
    headerRef,
    historyIndex,
    undoFunction,
    redoFunction,
  ...
  return (
    <div
      className="bg-card flex gap-1 justify-between py-1 px-0.5 border-b shadow-sm"
      ref={headerRef}
    >
            ...
            <TooltipTrigger asChild>
              <div className="inline-block">
                <Button
                  ...
                  disabled={
                    historyIndex.current === 0 || saveState === "WAITING"
                  }
                  size="icon"
                  variant="ghost"
